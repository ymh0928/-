...
const NormalLoginFormS = (props) => {
  const { history } = props;
  const { setStudent, setAuthStudent } = useContext(allContext);
  ...
  const handleLogin = (e) => {
    ...
    // const values = ref.getFieldsValue(["sName", "sWord"]);
    // const { sName, sWord } = values;
...
export default withRouter(NormalLoginFormS);
